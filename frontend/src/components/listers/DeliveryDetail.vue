<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="PickDt" v-model="item.pickDt" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="FinishCook" v-model="item.finishCook" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
