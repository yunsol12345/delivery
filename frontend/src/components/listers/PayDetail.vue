<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="CustomerName" v-model="item.customerName" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="CustomerAddress" v-model="item.customerAddress" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="PayDate" v-model="item.payDate" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
